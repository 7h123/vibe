    ...
    return (
        <div className="p-8 pb-32">
            <div className="flex justify-between items-center mb-8">
                <h1 className="font-display text-[28px] text-dark">Produits</h1>
            ...
            <div className="bg-bg-secondary w-full overflow-x-auto">
                <table className="w-full text-left">
                    <thead>
                        <tr className="border-b border-dark/10">
                            {['IMAGE', 'NOM', 'CATÉGORIE', 'PRIX', 'EN STOCK', 'VEDETTE', 'ACTIONS'].map(h => (
                        ...
                        {products.map(prod => (
                            <tr key={prod._id} className="border-b border-dark/5">
                                ...
                                <td className="py-3 px-4 font-body text-[13px] text-gold">
                                    {prod.priceOnRequest ? 'Sur devis' : `${prod.price?.toLocaleString()} MAD`}
                                </td>
                                ...
                                <td className="py-3 px-4 font-body text-[13px]">
                                    <span className={`inline-block px-2 py-1 text-[9px] tracking-wider uppercase ${prod.isFeatured ? 'bg-yellow-100 text-yellow-700' : 'bg-gray-100 text-gray-500'}`}>
                                        {prod.isFeatured ? 'Vedette' : 'Standard'}
                                    </span>
                                </td>
                                <td className="py-3 px-4">
                                    {deleteConfirm === prod._id ? (
                                        <div className="flex items-center gap-3">
                                            ...
                                            <button onClick={() => handleDelete(prod._id)} className="font-body text-[10px] text-dark hover:underline">Oui</button>
                ...
                {products.length === 0 && <p className="p-6 text-center font-body text-sm text-text-sec">Aucun produit.</p>}
            </div>
            ...
            {modalOpen && (
                <div className="fixed inset-0 bg-dark/60 z-50 flex items-center justify-center p-5">
                    <div className="bg-bg-secondary w-full max-w-[700px] p-10 relative max-h-[90vh] overflow-y-auto">
                        ...
                        <h2 className="font-display text-[22px] text-dark mb-8">{editingId ? 'MODIFIER LE PRODUIT' : 'AJOUTER UN PRODUIT'}</h2>

                        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                            <div className="grid grid-cols-2 gap-5">
                                <div>
                                    <label className="font-body text-[10px] tracking-[0.15em] uppercase text-text-sec block mb-1">Nom du produit *</label>
                                ...
                                <div>
                                    <label className="font-body text-[10px] tracking-[0.15em] uppercase text-text-sec block mb-1">Slug *</label>
                            ...
                            <div className="grid grid-cols-2 gap-5">
                                <div>
                                    <label className="font-body text-[10px] tracking-[0.15em] uppercase text-text-sec block mb-1">Catégorie *</label>
                                ...
                                <div>
                                    <label className="font-body text-[10px] tracking-[0.15em] uppercase text-text-sec block mb-1">Matériau</label>
                            ...
                            <div className="grid grid-cols-2 gap-5 items-end">
                                <div>
                                    <label className="font-body text-[10px] tracking-[0.15em] uppercase text-text-sec block mb-1">Prix (MAD) *</label>
                                    {!priceOnRequest ? (
                                        ...
                                        <div className="w-full h-10 flex items-center border-b border-dark/20 font-body text-sm text-text-sec opacity-50">Sur devis</div>
                                    )}
                                </div>
                                <div className="flex items-center gap-2 h-10 pb-2">
                                    ...
                                    <label htmlFor="priceOnRequest" className="font-body text-[12px] text-dark cursor-pointer">Prix sur demande</label>
                                </div>
                            </div>

                            <div className="grid grid-cols-2 gap-5">
                                <div>
                                    <label className="font-body text-[10px] tracking-[0.15em] uppercase text-text-sec block mb-1">Dimensions</label>
                                ...
                                <div>
                                    <label className="font-body text-[10px] tracking-[0.15em] uppercase text-text-sec block mb-1">Poids</label>
                            ...
                            <div className="grid grid-cols-2 gap-5">
                                <div>
                                    <label className="font-body text-[10px] tracking-[0.15em] uppercase text-text-sec block mb-1">Finition</label>
                                ...
                                <div>
                                    <label className="font-body text-[10px] tracking-[0.15em] uppercase text-text-sec block mb-1">Délai</label>
                            ...
                            <div>
                                <label className="font-body text-[10px] tracking-[0.15em] uppercase text-text-sec block mb-1">Description Courte</label>
                            ...
                            <div>
                                <label className="font-body text-[10px] tracking-[0.15em] uppercase text-text-sec block mb-1">Description Longue</label>
                            ...
                            <div>
                                <label className="font-body text-[10px] tracking-[0.15em] uppercase text-text-sec block mb-2">Image Principale</label>
                            ...
                            <div className="flex items-center gap-6 mt-2">
                                <div className="flex items-center gap-2">
                                    ...
                                    <label htmlFor="inStock" className="font-body text-[12px] text-dark cursor-pointer">En Stock</label>
                                </div>
                                <div className="flex items-center gap-2">
                                    ...
                                    <label htmlFor="isFeatured" className="font-body text-[12px] text-dark cursor-pointer">Produit Vedette</label>
                                </div>
                            </div>
